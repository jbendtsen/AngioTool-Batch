...
try:
    os.remove("AngioTool-Batch-r7.jar")
except:
    pass

with zipfile.ZipFile("AngioTool-Batch-r7.jar", compression=zipfile.ZIP_DEFLATED, compresslevel=6, mode="w") as zip:
...
# java -Dsun.java2d.uiScale=2 -jar AngioTool-Batch-r7.jar
