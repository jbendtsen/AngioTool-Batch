...
public class AngioToolAboutBox extends JDialog implements MouseListener {
   ...
   private void initComponents() {
      ...
      versionLabel.setText("Version 0.6a (02.18.14)");
      this.aboutBoxPanel.add(versionLabel, new AbsoluteConstraints(260, 70, 320, -1));
      ...
      this.aboutBoxPanel.add(this.jScrollPane1, new AbsoluteConstraints(10, 230, 760, 470));
