...
public class Utils {
   ...
   public static String NAME = "AngioTool64";
   public static final String INTERNAL_NAME = "AngioToolKike";
   public static final String VERSION = "0.6a";
   public static final String VERSION_Title = "0.6a (02.18.14)";
   ...
   public static String getSystemInfo() {
      ...
      for(Object key : new TreeSet<Object>(pr.keySet())) {
